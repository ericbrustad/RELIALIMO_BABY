...
export class DriverTracker {
  ...
  convertToTrackedDriver(d, idx) {
    ...
    return {
      ...
      city: d.city || '',
      state: d.state || '',
      postal_code: d.postal_code || d.address_zip || '',
      license_number: d.license_number || '',
      license_state: d.license_state || '',
      license_exp_date: d.license_exp_date || '',
      tlc_license: d.tlc_license || '',
      badge_id: d.badge_id || '',
      hire_date: d.hire_date || '',
      driver_level: d.driver_level || '0',
      driver_type: d.type || 'FULL TIME',

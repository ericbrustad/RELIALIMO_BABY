...
// Check if we're inside an iframe (e.g., for embedded views)
// If in iframe, the parent may handle auth - check with parent first
...
const handleAuth = async () => {
  // If we're inside an iframe, try to get session from parent first
  // This supports embedded views where parent may have auth context
  if (isInsideIframe()) {
    console.log('AuthGuard: Running in iframe, checking parent for auth');

export class MapManager {
  ...
  createDriverPopupContent(driver) {
    ...
    const addressParts = [driver.primary_address, driver.city, driver.state, driver.postal_code].filter(Boolean);
    const fullAddress = addressParts.join(', ');
    
    return `
      <div class="popup-content driver-popup-expanded">
        ...
        <div class="popup-info">
          ...
          ${driver.phone ? `
          <div class="popup-field">
            <span class="popup-label">Cell:</span>
            <span class="popup-value"><a href="tel:${driver.phone}">${formatPhone(driver.phone)}</a></span>
          </div>
          ` : ''}
          ${driver.email ? `
          <div class="popup-field">
            <span class="popup-label">Email:</span>
            <span class="popup-value"><a href="mailto:${driver.email}">${driver.email}</a></span>
          </div>
          ` : ''}
          ${driver.affiliate ? `
          <div class="popup-field">
            <span class="popup-label">Company:</span>
            <span class="popup-value">${driver.affiliate}</span>
          </div>
          ` : ''}
          ${driver.driver_type ? `
          <div class="popup-field">
            <span class="popup-label">Type:</span>
            <span class="popup-value">${driver.driver_type}</span>
          </div>
          ` : ''}
          ${driver.license_number ? `
          <div class="popup-field">
            <span class="popup-label">License:</span>
            <span class="popup-value">${driver.license_number} (${driver.license_state || 'N/A'})</span>
          </div>
          ` : ''}
          ${driver.license_exp_date ? `
          <div class="popup-field">
            <span class="popup-label">License Exp:</span>
            <span class="popup-value">${formatDate(driver.license_exp_date)}</span>
          </div>
          ` : ''}
          ${driver.badge_id ? `
          <div class="popup-field">
            <span class="popup-label">Badge ID:</span>
            <span class="popup-value">${driver.badge_id}</span>
          </div>
          ` : ''}
          ${fullAddress ? `
          <div class="popup-field">
            <span class="popup-label">Address:</span>
            <span class="popup-value">${fullAddress}</span>
          </div>
          ` : ''}
          <div class="popup-field">
